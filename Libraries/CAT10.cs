...
namespace DecerixUPC.Libraries
{
    class CAT10
    {
        ...
        public CAT10(string[] array, HelpDecode decode, int id, int Offset)
        {
            try
            {
                //Decode FSPEC
                ...
                if (FSPEC[0] == '1')
                {
                    ...
                    numItems++;
                    FRN.Add(1);
                    offset.Add(offset.Last() + index);
                    FieldType.Add("I010/010");
                    Description.Add("Date Source Identifier");
                ...
                if (FSPEC[2] == '1')
                {
                    ...
                    FRN.Add(3);
                    offset.Add(offset.Last() + index);
                    FieldType.Add("I010/020");
                    Description.Add("Target Report Descriptor");
                }
                ...
                if (FSPEC[4] == '1')
                {
                    ...
                    FRN.Add(5);
                    offset.Add(offset.Last() + index);
                    FieldType.Add("I010/041");
                    Description.Add("Position in WGS - 84 Co - ordinates");
                ...
                if (FSPEC[5] == '1')
                {
                    ...
                    FRN.Add(6);
                    offset.Add(offset.Last() + index);
                    FieldType.Add("I010/040");
                    Description.Add("Measured Position in Polar Co - ordinates");
                }
                ...
                if (FSPEC[6] == '1')
                {
                    ...
                    FRN.Add(7);
                    offset.Add(offset.Last() + index);
                    FieldType.Add("I010/042");
                    Description.Add("Position in Cartesian Co - ordinates");
               ...
               Format : Four-Octet fixed length data item. */
                if (FSPEC[7] == '1')
                {
                    ...
                    FRN.Add(8);
                    offset.Add(offset.Last() + index);
                    FieldType.Add("I010/200");
                    Description.Add("Calculated Track Velocity in Polar Co - ordinates");
                }
                ...
                if (FSPEC.Count() > 8)
                {
                    ...
                    if (FSPEC[8] == '1')
                    {
                        ...
                        FRN.Add(9);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/202");
                        Description.Add("Calculated Track Velocity in Cartesian Co - ordinates");
                    }
                    ...
                    if (FSPEC[9] == '1')
                    {
                        ...
                        FRN.Add(10);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/161");
                        Description.Add("Track Number");
                    }
                    ...
                    if (FSPEC[10] == '1')
                    {
                        ...
                        FRN.Add(11);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/170");
                        Description.Add("Track Status");
                    }
                    ...
                    if (FSPEC[11] == '1')
                    {
                        ...
                        FRN.Add(12);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/060");
                        Description.Add("Mode-3/A Code in Octal Representation");
                    }
                   ...
                   Format: Three-octet fixed length Data Item. */
                    if (FSPEC[12] == '1')
                    {
                        ...
                        FRN.Add(13);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/220");
                        Description.Add("Target Address");
                    }
                    ...
                    if (FSPEC[13] == '1')
                    {
                        ...
                        FRN.Add(14);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/245");
                        Description.Add("Target Identification");
                    }
                    ...
                    if (FSPEC[14] == '1')
                    {
                        ...
                        FRN.Add(15);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/250");
                        Description.Add("Mode S MB Data");
                    }
                ...
                if (FSPEC.Count() > 15)
                {
                    ...
                    if (FSPEC[15] == '1')
                    {
                        ...
                        FRN.Add(16);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/300");
                        Description.Add("Vehicle Fleet Identification");
                    }
                    ...
                    if (FSPEC[16] == '1')
                    {
                        ...
                        FRN.Add(17);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/090");
                        Description.Add("Flight Level in Binary Representation");
                    }
                    ...
                    if (FSPEC[17] == '1')
                    {
                        ...
                        FRN.Add(18);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/091");
                        Description.Add("Measured Height");
                    }
                    ...
                    if (FSPEC[18] == '1')
                    {
                        ...
                        FRN.Add(19);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/270");
                        Description.Add("Target Size & Orientation");
                    }
                    ...
                    if (FSPEC[19] == '1')
                    {
                        ...
                        FRN.Add(20);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/550");
                        Description.Add("System Status");
                    }
                    ...
                    if (FSPEC[20] == '1')
                    {
                        ...
                        FRN.Add(21);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/310");
                        Description.Add("Pre-programmed Message");
                    }
                }
                ...
                if (FSPEC.Count() > 21)
                {
                    ...
                    if (FSPEC[21] == '1')
                    {
                        ...
                        FRN.Add(22);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/500");
                        Description.Add("Standard Deviation of Position");
                    }
                    ...
                    */
                    if (FSPEC[23] == '1')
                    {
                        ...
                        FRN.Add(24);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/131");
                        Description.Add("Amplitude of Primary Plot");
                    }
                    ...
                    if (FSPEC[24] == '1')
                    {
                        ...
                        FRN.Add(25);
                        offset.Add(offset.Last() + index);
                        FieldType.Add("I010/210");
                        Description.Add("Calculated Acceleration");
                    }
