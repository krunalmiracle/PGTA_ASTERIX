...
namespace DecerixUPC.Libraries
{
    class CAT21Helper
    {
        ...
        public string SA;
        public int Compute_Aircraft_Operational_Status(string[] message, int pos)
        {
        ...
        public int Compute_Service_Identification(string[] message, int pos)
        {
        ...
        /// </summary>
        public string RP;
        public int Compute_Service_Managment(string[] message, int pos)
        {
        ...
        //EMITTER CATEGORY
        public string ECAT;
        public int Compute_Emitter_Category(string[] message, int pos)
        {
        ...
        public string RCF;
        public string FX;
        public int Compute_Target_Report_Descripter(string[] message, int pos)
        {
            char[] OctetoChar = message[pos].ToCharArray(0, 8);
        ...
        public int Compute_Mode_A3(string[] message, int pos)
        {
        ...
        public int Compute_Time_of_Aplicabillity_Position(string[] message, int pos)
        {
        ...
        public int Compute_Time_of_Aplicabillity_Velocity(string[] message, int pos)
        {
            int str = Convert.ToInt32(string.Concat(message[pos], message[pos + 1], message[pos + 2]), 2);
            double segundos = (Convert.ToDouble(str) / 128);
            TimeSpan tiempo = TimeSpan.FromSeconds(segundos);
        ...
        public int Compute_Time_of_Message_Reception_Position(string[] message, int pos)
        {
            int str = Convert.ToInt32(string.Concat(message[pos], message[pos + 1], message[pos + 2]), 2);
            double segundos = (Convert.ToDouble(str) / 128);
            TimeSpan tiempo = TimeSpan.FromSeconds(segundos);
        ...
        public int Compute_Time_of_Message_Reception_Position_High_Precision(string[] message, int pos)
        {
        ...
        public int Compute_Time_of_Message_Reception_Velocity(string[] message, int pos)
        {
            int str = Convert.ToInt32(string.Concat(message[pos], message[pos + 1], message[pos + 2]), 2);
            double segundos = (Convert.ToDouble(str) / 128);
            TimeSpan tiempo = TimeSpan.FromSeconds(segundos);
        ...
        public int Compute_Time_of_Message_Reception_Velocity_High_Precision(string[] message, int pos)
        {
            string octet = string.Concat(message[pos], message[pos + 1], message[pos + 2], message[pos + 3]);
            string FSI = octet.Substring(0, 2);
            string time = octet.Substring(2, 30);
        ...
        public int Compute_Time_of_Asterix_Report_Transmission(string[] message, int pos)
        {
        ...
        public int Compute_Quality_Indicators(string[] message, int pos)
        {
        ...
        public string[] TOV;
        public string[] TTR;
        public int Compute_Trajectory_Intent(string[] message, int pos)
        {
        ...
        public int Compute_PositionWGS_84(string[] message, int pos)
        {
        ...
        public int Compute_High_Resolution_PositionWGS_84(string[] message, int pos)
        {
        ...
        public int Compute_Message_Amplitude(string[] message, int pos)
        {
        ...
        public int Compute_Geometric_Height(string[] message, int pos)
        {
        ...
        public int Compute_Flight_level(string[] message, int pos)
        {
        ...
        public int Compute_Selected_Altitude(string[] message, int pos)
        {
        ...
        public int Compute_Final_State_Selected_Altitude(string[] message, int pos)
        {
        ...
        public int Compute_Air_Speed(string[] message, int pos)
        {
        ...
        public int Compute_True_Air_Speed(string[] message, int pos)
        {
        ...
        public int Compute_Magnetic_Heading(string[] message, int pos)
        {
        ...
        public int Compute_Barometric_Vertical_Rate(string[] message, int pos)
        {
            if (message[pos].Substring(0, 1) == "0")
            {
        ...
        public int Compute_Geometric_Vertical_Rate(string[] message, int pos)
        {
            if (message[pos].Substring(0, 1) == "0")
            {
        ...
        public int Compute_Airborne_Ground_Vector(string[] message, int pos)
        {
            if (message[pos].Substring(0, 1) == "0")
            {
        ...
        public int Compute_Track_Angle_Rate(string[] message, int pos)
        {
        ...
        public string PS;
        public string SS;
        public int Compute_Target_Status(string[] message, int pos)
        {
        ...
        public string LTT;
        public string MOPS;
        public int Compute_MOPS_Version(string[] message, int pos)
        {
        ...
        public int Compute_Met_Information(string[] message, int pos)
        {
            MET_present = 1;
            int posin = pos;
            int posfin = pos++;
        ...
        public int Compute_Roll_Angle(string[] message, int pos)
        {
        ...
        public string TTI;
        public string TID;
        public int Compute_ACAS_Resolution_Advisory_Report(string[] message, int pos)
        {
        ...
        public int Compute_Surface_Capabiliteies_and_Characteristics(string[] message, int pos)
        {
        ...
        public string SCC;
        public int Compute_Data_Age(string[] message, int pos)
        {
            Data_Ages_present = 1;
            int posin = pos;
            if (message[pos].Substring(7, 1) == "1")
        ...
        public int Compute_Receiver_ID(string[] message, int pos)
        {
